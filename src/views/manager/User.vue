  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="typeAddress" label="地区"/>
    ...
    <el-dialog title="用户信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="gander" label="性别">
          <el-input v-model="data.form.gender" placeholder="请输入性别"></el-input>
        </el-form-item>
        <el-form-item prop ="address" label ="地址">
          <el-select v-model="data.form.typeAddress" placeholder="请选择地址">
            <el-option label= "福州" value ="福州"></el-option>
            <el-option label= "莆田" value ="莆田"></el-option>
            <el-option label= "宁德" value ="宁德"></el-option>
            <el-option label= "泉州" value ="泉州"></el-option>
            <el-option label= "厦门" value ="厦门"></el-option>
            <el-option label= "漳州" value ="漳州"></el-option>
            <el-option label= "龙岩" value ="龙岩"></el-option>
            <el-option label= "南平" value ="南平"></el-option>
            <el-option label= "三明" value ="三明"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <template #footer>
