<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.title" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入分类标题查询"></el-input>
    ...
    <el-dialog title="疾病证型" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="title" label="分类标题">
          <el-input v-model="data.form.title" placeholder="请输入分类标题"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
