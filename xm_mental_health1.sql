/*
 ...
 Source Server         : localhost_3307密码123456
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 'admin', '管理员', 'http://localhost:9090/files/download/1743245147564-ATL 血压计.png', 'ADMIN', '18899990011', 'admin2@HTN.com', '宁德');
...
CREATE TABLE `doctor`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '头像',
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '角色',
  `seniority` int NULL DEFAULT NULL COMMENT '工龄',
...
CREATE TABLE `feedback`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '反馈建议表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `propagate`  (
  ...
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '发布时间',
  `num` int NULL DEFAULT 0 COMMENT '浏览量',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `propagate` VALUES (1, 1, '高血压的中医角度分析与调理', 'http://localhost:9090/files/download/1740933692137-OIP.jpg', '<h1 style=\"text-align: center;\">高血压的中医角度分析与调理</h1>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高血压是一种常见的慢性疾病，其特点是动脉血压持续升高。随着现代生活节奏的加快，工作压力和不良的生活习惯，高血压的发病率呈上升趋势。西医通过药物控制血压，而中医学则强调辨证施治，从整体调理入手，旨在调整体内的阴阳平衡，恢复人体的自我调节能力。</span></p>\r\n<p style=\"text-align: center;\"><img src=\"http://localhost:9090/files/download/1728369216859-心理健康宣传02.jpg\" alt=\"\" data-href=\"\" style=\"\"></p>\r\n<h2 style=\"text-align: start;\">一、从中医角度看高血压的病因</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp中医认为，高血压的发生与肝、肾、脾等脏腑的功能失调密切相关。首先，肝气郁结是高血压的重要病因之一。情绪波动、压力过大、长期的抑郁、焦虑等情绪困扰，容易导致肝气郁结，肝气郁结则可引发气滞血瘀，最终引发血压升高。其次，肾精不足也是导致高血压的常见原因。肾为“先天之本”，肾精充足能够滋养全身，而肾精亏虚，尤其是中老年人群中，容易导致阴虚火旺，火热上升，压迫心脉，导致血压升高。另外，脾虚也会影响到气血生化功能，脾气虚弱不能有效运化水湿，形成痰湿，阻碍气血的流畅，间接导致血压升高。</span></p>\r\n<h2 style=\"text-align: start;\">二、高血压的主要表现及其辨证</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp中医辨证治疗高血压，首先要对症状进行辨别。根据不同的病因，中医将高血压分为几种不同的类型。常见的类型包括肝阳上亢型、肾阴虚型、气滞血瘀型等。肝阳上亢型的患者多表现为头晕头痛、目眩耳鸣、面红目赤等，伴随有情绪波动较大；肾阴虚型的患者则常见腰膝酸软、五心烦热、失眠多梦等症状；气滞血瘀型的患者则表现为胸闷、心悸、乏力、疼痛等。</span></p>\r\n<h2 style=\"text-align: start;\">三、结语</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp中医治疗高血压不仅仅依赖于药物，更注重整体调理和个体差异。通过辨证施治，中医能够帮助患者从根本上恢复身体的平衡，达到降压的效果。与此同时，配合日常生活中的调理，如保持良好的心态和健康的生活习惯，将更有利于高血压的预防和治疗。</span></p>\r\n<h3 style=\"text-align: start;\">\r\n</h3>', '2025-02-15 14:33:44', 10);
INSERT INTO `propagate` VALUES (2, 1, '全国高血压日！快快收藏这篇文章，助你避开五个高血压误区', 'http://localhost:9090/files/download/1740933698478-OIP-C.jpg', '<h1 style=\"text-align: center;\">全国高血压日！快快收藏这篇文章，助你避开五个高血压误区</h1>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp市卫健委介绍，今天是“全国高血压日”，近年来，我国的高血压患者有年轻化的趋势，全年龄人群都应养成预防意识。市疾病预防控制中心专家来教大家识别五个高血压误区。一起来看↓</span></p>\r\n<p style=\"text-align: center;\"><img src=\"http://localhost:9090/files/download/1728369216859-心理健康宣传02.jpg\" alt=\"\" data-href=\"\" style=\"\"></p>\r\n<h2 style=\"text-align: start;\">误区一：单次血压高，就是高血压</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp血压的波动是一个复杂且多变的过程，受到很多因素的影响。当您发现单次血压测量值偏高时，不必过度惊慌。为获取更加准确、真实的血压数据，测量时需注意以下几点：1、确保测量环境安静舒适。2、测量前30分钟内，禁止吸烟、饮酒、摄入咖啡或茶等。3、不要进行剧烈运动或用力活动，并排空膀胱。4、测量前休息至少5分钟，确保身体处于放松状态。值得注意的是，高血压的诊断需要在非同日进行3次血压测量，并且每次测量的收缩压≥140毫米汞柱和/或舒张压≥90毫米汞柱。此外，为了更准确地反映血压状况，建议每次测量2-3次，取平均值作为参考。</span></p>\r\n<h2 style=\"text-align: start;\">误区二：水银血压计，测量更准确</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp在老一辈人眼中，水银血压计似乎总是与“准确”一词紧密相连。水银柱血压计确实有其独特的准确性，但其使用方法较复杂，需要经过专业培训的医务人员操作，在测量过程中，若不注意放气速度、水平读数、听诊器位置等细节，都可能会产生较大的误差。相比之下，经过国际标准认证的上臂式电子血压计更加适合居家测量。此外，腕式、手指式电子血压计的测量精准度较差，不推荐居家测量时使用。</span></p>\r\n<h2 style=\"text-align: start;\">误区三：做饭用盐少，血压必不高</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp很多高血压患者都知道做饭要少放盐，盐中的钠元素能导致血压上升，但其他调味品，如汤料包、辣椒酱、豆瓣酱等也含有大量的钠，某些面条、面包、三明治、奶酪、罐装食品等“不太咸”的食物，也可能会含有大量的钠，要注意多加辨别。除了食物之外，非处方药也是钠的“隐形来源”。就诊时，高血压患者应主动告知病史，以便医生在选择药物时避免与药效冲突。</span></p>\r\n<h3 style=\"text-align: start;\">误区四：高压没症状，危害不找我</h3>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp得了高血压不一定都有明显症状。一方面，大部分高血压患者的靶器官微小损伤是悄然发生的，可能就是没太大感觉；另一方面，不同人的耐受程度也不相同，有些人对于不适症状不敏感，这可能导致诊断的延迟，越晚发现，器官损害就越大。因此，建议35岁及以上人群定期检测血压，早期发现、早期干预，规律服药、控制血压，才能延缓并发症发生，提高远期生活质量。</span></p>\r\n<h3 style=\"text-align: start;\">误区五：吃药多伤身，一降就可停</h3>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp很多患者对服药仍抱有一定的抵触心理，觉得“是药三分毒”，越少吃药对身体的损伤越小。有些患者可能听说某种食物具有降血压的功效，就大量进食希望以此改善血压水平，或者寻求保健品而非服用具有确定疗效的药品。更常见的是，有些患者一旦血压降到控制标准，就间隔服药，甚至停药。以上做法都是错误的。虽然药物确实可能存在一定的不良反应，但这些不良反应远不如血压不控制造成的损害大，减药、停药会导致血压波动加大，对血管损伤更大。</span></p>\r\n', '2025-02-15 17:31:43', 21);
INSERT INTO `propagate` VALUES (3, 2, '慢性病防治丨正确认识高血压', 'http://localhost:9090/files/download/1743253650806-微信图片_20250215220936.jpeg', '<h1 style=\"text-align: center;\">慢性病防治正确认识高血压</h1>\r\n<p style=\"text-align: center;\"><img src=\"http://localhost:9090/files/download/1728369216859-心理健康宣传02.jpg\" alt=\"\" data-href=\"\" style=\"\"></p>\r\n<h2 style=\"text-align: start;\">01身体原因</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp遗传因素影响显著，家族有高血压病史，后代发病风险会大幅提升；年龄增长也是关键因素，血管壁会逐渐失去弹性、变僵硬，导致血液流动阻力增大，一般来说，40 岁以后，高血压患病率明显攀升；此外，身体超重、肥胖，体内脂肪堆积，小动脉硬化，会促使外周血管阻力增加，引发血压上升。</span></p>\r\n<h2 style=\"text-align: start;\">02生活方式</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高盐饮食使人体的血容量增加，加重心脏与血管负担，每日摄入钠盐超过 5 克就会埋下隐患；长期过量饮酒，酒精刺激血管收缩，还干扰体内激素平衡，易诱发血压波动；抽烟则让血管内皮受损，加速动脉粥样硬化进程，提升高血压发病几率；缺乏运动、长期精神紧张焦虑，身体会分泌肾上腺素等激素，致使心跳加快、血管收缩，推动血压升高。</span></p>\r\n<h2 style=\"text-align: start;\">03药物与疾病关联</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp某些药物，比如避孕药、类固醇、某些抗抑郁药物，会干扰身体的激素或体液平衡，引发血压上升；肾脏疾病、内分泌疾病（如原发性醛固酮增多症）、心血管疾病等，或是影响肾脏排水排钠功能，或是改变激素调节，最终导致血压居高不下。</span></p>\r\n<h2 style=\"text-align: start;\">04症状</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp部分高血压患者初期毫无症状，或仅出现偶尔头晕、头痛、心悸、耳鸣等轻微不适，所以容易被忽视。当血压突然急剧升高，可能造成剧烈头痛、视力模糊、鼻出血、胸闷胸痛等较为严重的症状。</span></p>\r\n<h2 style=\"text-align: start;\">05危害</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp血压长期过高，会对心脏、大脑、肾脏、眼睛等重要器官都造成损伤。在心脏方面，引发左心室肥厚、扩大，逐步发展成心力衰竭，还会提高冠心病、心律失常的发病风险；作用于脑血管，微小动脉瘤破裂可致脑出血，粥样硬化斑块脱落堵塞血管，会诱发脑梗死；累及肾脏，会破坏肾脏的滤过功能，严重时引发肾衰竭；影响眼睛，造成视网膜病变，视力下降甚至失明。</span></p>\r\n', '2025-02-15 17:33:55', 2);
INSERT INTO `propagate` VALUES (4, 2, '把血压控制在这个数，大大降低风险！记住这几个小方法', 'http://localhost:9090/files/download/1743253667113-v2-3901f48267a748ec3e7e7bb9d618fcd1_b.jpg', '<h1 style=\"text-align: center;\">把血压控制在这个数，大大降低风险！记住这几个小方法</h1>\r\n<p style=\"text-align: center;\"><img src=\"http://localhost:9090/files/download/1728369216859-心理健康宣传02.jpg\" alt=\"\" data-href=\"\" style=\"\"></p>\r\n<h2 style=\"text-align: start;\">坚持运动</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp对于高血压患者，运动降压确实有效。《中国高血压防治指南（2024年修订版）》推荐对于血压控制良好的高血压患者，推荐以有氧运动为主、抗阻运动为辅的混合训练，也建议同时结合呼吸训练与柔韧性和拉伸训练②，例如快走、慢跑、游泳、自行车、健身操、跳绳等。</span></p>\r\n<h2 style=\"text-align: start;\">低钠饮食</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp2022年，《中国循环杂志》上发表了一项研究显示，把家里的盐换成低钠盐，每年能减少100万人死亡③。低钠盐是在普通食盐（氯化钠含量 90%～99%）中混入一定比例、同样具有咸味的氯化钾，减少钠的摄入。不过低钠盐中含有钾，对于肾病、血钾高的人群并不适合。</span></p>\r\n<h2 style=\"text-align: start;\">少油低脂</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp日常饮食中，可以多食用全谷物、水果、蔬菜和低脂乳制品，减少如油炸、奶油等含饱和脂肪和胆固醇的饮食摄入，有助于降低血压。</span></p>\r\n<h2 style=\"text-align: start;\">控制体重</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp2021年，梅奥诊所发布了药物以外的降压方法，其中就提到了控制体重与腰围④。当一个人超重或肥胖时，减肥往往是控制血压最有效的办法之一，哪怕只是减去一点体重。除了体重，还应重视腰围，过多的腰部赘肉也会增加高血压风险。</span></p>\r\n<h2 style=\"text-align: start;\">充足睡眠</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp2023年《高血压》杂志发表了一项研究发现，入睡困难、睡眠中断和睡眠时间短均与高血压风险较高相关⑤。与每天睡眠7-8小时相比，报告睡眠时间更短的人，高血压风险显著增加；而且，存在入睡困难或睡眠中断、早醒的人，高血压风险明显更高。</span></p>\r\n<h2 style=\"text-align: start;\">远离烟酒</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp吸烟会导致血压升高，心率也会升高。烟草中的化学物质会损坏血管壁，引起血管炎症、硬化，并收缩动脉血管，动脉硬化会导致血压升高。而且二手烟、三手烟也会影响血管。饮酒也是导致高血压的重要因素之一。喜好烟酒的高血压患者，尽量戒掉为好。</span></p>\r\n<h2 style=\"text-align: start;\">良好心态</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp如果心态不好，经常愤怒、暴躁、紧张、焦虑，就容易导致交感神经兴奋，引起血压升高。所以，尽量保持良好心态有利于血压的控制。</span></p>\r\n\r\n\r\n\r\n', '2025-02-15 17:36:44', 35);
INSERT INTO `propagate` VALUES (5, 3, '世界高血压日：提高公众对高血压的认识与预防', 'http://localhost:9090/files/download/1743253568472-R.jpg', '<h1 style=\"text-align: center;\">慢性病防治正确认识高血压</h1>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp每年的5月17日是世界高血压日，这一天旨在提高全球公众对高血压的认识，并提醒人们关注这一常见的健康问题。高血压被誉为“沉默的杀手”，因为它在早期往往没有明显的症状，但如果得不到有效控制，可能会导致心脏病、脑卒中、肾衰竭等严重健康问题。世界高血压日的设立，不仅让人们意识到高血压的危害，更重要的是鼓励大家采取有效的预防和治疗措施。</span></p>\r\n<p style=\"text-align: center;\"><img src=\"http://localhost:9090/files/download/1728369216859-心理健康宣传02.jpg\" alt=\"\" data-href=\"\" style=\"\"></p>\r\n<h2 style=\"text-align: start;\">一、高血压的全球流行状况</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高血压是一种常见的慢性病，全球约有13亿人患有高血压。根据世界卫生组织（WHO）的统计，高血压是全球死亡和残疾的主要原因之一。尽管它在发病初期可能没有明显症状，但其对健康的影响却极为深远，长期高血压会导致心血管疾病、脑卒中、肾衰竭等并发症的发生。而且，随着人们生活方式的改变和人口老龄化，高血压的患病率呈逐年上升趋势，已成为全球健康面临的重要挑战。</span></p>\r\n<h2 style=\"text-align: start;\">二、高血压的危害</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高血压的危害不容忽视。它是导致心脏病、脑卒中、肾脏疾病等重大疾病的重要原因。高血压会增加心脏的负担，导致心脏肥大，最终可能引发心力衰竭；它还会损伤血管壁，促进动脉硬化，进一步增加心脑血管事件的风险。此外，长期高血压还可能引起眼底出血、视力丧失等问题，甚至对肾脏造成不可逆的损害，导致肾功能衰竭。因此，高血压的控制与管理，直接关系到人们的健康与生活质量。</span></p>\r\n<h2 style=\"text-align: start;\">三、为什么要重视高血压的防治</h2>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp虽然高血压的危害巨大，但它是一种可以通过早期筛查、生活方式改变以及药物治疗来有效预防和控制的疾病。许多人并未意识到自己已经患有高血压，因为它通常在初期没有明显症状。然而，如果不进行干预，血压长期升高将给健康带来不可逆的损害。因此，定期监测血压对于高血压的早期发现至关重要。世界高血压日的目标就是提高公众对高血压的认识，普及高血压的防治知识，让更多的人关注自己的血压状况，及时采取措施进行干预。通过定期检测血压，及早发现异常，能够有效降低高血压的危害，防止严重并发症的发生。</span></p>\r\n<h3 style=\"text-align: start;\">四、高血压的预防与控制</h3>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高血压的防治不仅仅依赖药物治疗，更多的是通过健康的生活方式来控制血压。首先，合理饮食是预防高血压的重要措施。减少盐的摄入、增加蔬菜水果的摄入，保持饮食清淡，避免高脂肪、高糖分的食物。其次，保持适当的体重和进行规律运动，尤其是有氧运动，如快走、跑步、游泳等，可以增强心血管功能，帮助降低血压。此外，戒烟限酒也是预防高血压的重要手段。吸烟和过度饮酒都容易导致血管收缩，增加心脏负担，从而升高血压。保持充足的睡眠，减少心理压力，避免情绪波动，也是控制血压的重要方面。心理压力和焦虑不仅会导致血压升高，还可能影响心血管健康，因此，学会放松和管理压力，对预防高血压至关重要。</span></p>\r\n<h4 style=\"text-align: start;\">五、世界高血压日的倡导与行动</h4>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp每年的世界高血压日都有一个特定的主题，旨在促进公众对高血压的关注和采取相应行动。例如，近年来的主题涉及高血压的早期检测、健康饮食、心理压力管理等方面。世界高血压日的活动形式多样，包括健康讲座、义诊、血压测量等，鼓励人们主动参与，关注自己的健康状况。此外，世界高血压日还呼吁全球政府和公共卫生组织加强对高血压防治工作的投入，尤其是在低收入和中等收入国家，通过改善基础设施、普及健康教育、加强早期筛查等手段，减少高血压的负担。</span></p>\r\n<h4 style=\"text-align: start;\">结语</h4>\r\n<p style=\"text-align: start; line-height: 2;\"><span style=\"font-size: 16px;\">&nbsp&nbsp&nbsp&nbsp高血压是一种可以通过有效预防和管理来控制的疾病，而世界高血压日则为我们提供了一个重要的契机，提醒我们关注健康、定期监测血压，并通过健康的生活方式减少患病风险。通过科学的饮食、适量的运动、良好的作息和情绪管理，我们每个人都可以为自己的健康保驾护航。让我们在世界高血压日的号召下，行动起来，共同预防高血压，降低其对人类健康的威胁。</span></p>\r\n', '2025-02-15 17:39:38', 11);
...
CREATE TABLE `sideshow`  (
  ...
  `propagate_id` int NULL DEFAULT NULL COMMENT '健康宣传ID',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sideshow
-- ----------------------------
INSERT INTO `sideshow` VALUES (1, 'http://localhost:9090/files/download/1743245226429-351de70b-821f-44d9-bd21-0396abd80c84.jpeg.png', 1);
INSERT INTO `sideshow` VALUES (2, 'http://localhost:9090/files/download/1744558360145-1731302339459-轮播图02.jpg', 2);
INSERT INTO `sideshow` VALUES (3, 'http://localhost:9090/files/download/1743245241803-Camera_XHS_17396955191281040g00830q1kfnj17k405n6u.jpg', 3);
...
CREATE TABLE `test_paper`  (
  ...
  `doctor_id` int NULL DEFAULT NULL COMMENT '医生ID',
  `num` int NULL DEFAULT NULL COMMENT '题目数量',
  ...
  `test_num` int NULL DEFAULT 0 COMMENT '测试人数',
...
INSERT INTO `test_paper` VALUES (10, '测试题_痰瘀内蕴', 'http://localhost:9090/files/download/1739693108813-v2-3901f48267a748ec3e7e7bb9d618fcd1_b.jpg', ' 痰瘀内蕴型高血压多见于身体沉重、胸闷、头晕、水肿等症状。患者可能有消化不良、体重增加等问题，且常伴有胸口压迫感。此问卷帮助评估痰湿、血瘀的可能性以及它们对高血压的影响。', 4, 3, 10, 100, '[99,101,106,102,105,108,103,100,107,104]', '审核通过', 0, '2025-02-16 16:06:09', '0~40', '41~70', '71~100', '您有很低概率为痰瘀内蕴型高血压', '您有中等概率为痰瘀内蕴型高血压', '可能存在痰瘀内蕴型高血压的风险');
INSERT INTO `test_paper` VALUES (11, '测试题_瘀血内停', 'http://localhost:9090/files/download/1739693263984-OIP (1).jpg', '瘀血内停型高血压表现为头痛、胸闷、下肢浮肿、面色暗沉等症状。患者常感到疲劳、便秘、手脚麻木，舌质可能出现暗红或紫点。通过评估这些症状，可以帮助识别瘀血内停型高血压的风险。', 5, 4, 10, 100, '[112,110,116,109,115,114,113,118,117,111]', '审核通过', 2, '2025-02-16 16:08:45', '0~40', '41~70', '71~100', '您有很小概率为瘀血内停型高血压', '您有中等概率为瘀血内停型高血压', '可能存在瘀血内停型高血压的风险');
...
CREATE TABLE `test_record`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `test_paper_id` int NULL DEFAULT NULL COMMENT '测试卷ID',
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
  `doctor_id` int NULL DEFAULT NULL COMMENT '医生ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '测试记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `type_add_map`  (
  `typekey` int NOT NULL COMMENT 'typeKey对应type中id',
...
-- ----------------------------
INSERT INTO `type_add_map` VALUES (1, '厦门', 5);
INSERT INTO `type_add_map` VALUES (1, '莆田', 5);
INSERT INTO `type_add_map` VALUES (1, '漳州', 5);
INSERT INTO `type_add_map` VALUES (1, '泉州', 5);
INSERT INTO `type_add_map` VALUES (1, '宁德', 5);
INSERT INTO `type_add_map` VALUES (1, '三明', 5);
INSERT INTO `type_add_map` VALUES (1, '南平', 5);
INSERT INTO `type_add_map` VALUES (1, '龙岩', 5);
...
INSERT INTO `type_add_map` VALUES (5, '厦门', 9);
INSERT INTO `type_add_map` VALUES (5, '莆田', 2);
INSERT INTO `type_add_map` VALUES (5, '漳州', 0);
INSERT INTO `type_add_map` VALUES (5, '泉州', 0);
INSERT INTO `type_add_map` VALUES (5, '宁德', 8);
INSERT INTO `type_add_map` VALUES (5, '三明', 6);
INSERT INTO `type_add_map` VALUES (5, '南平', 0);
INSERT INTO `type_add_map` VALUES (5, '龙岩', 0);
INSERT INTO `type_add_map` VALUES (5, '福州', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'zhangsan', '123456', '张三', 'USER', '18800009999', 'zhangsan@HTN.com', 'http://localhost:9090/files/download/1744630366218-1721114905635-柴犬.jpeg', '厦门', '24', '男');
INSERT INTO `user` VALUES (2, 'lisi', '123456', '李四', 'USER', '19988887777', 'lisi@HTN.com', 'http://localhost:9090/files/download/1743245434232-1730724070459-柯基.jpeg', '龙岩', '22', '男');
INSERT INTO `user` VALUES (3, 'wangwu', '123456', '王五', 'USER', '18899997777', 'wangwu@HTN.com', 'http://localhost:9090/files/download/1743245440311-1730730752289-拉布拉多.jpeg', '南平', '23', '女');
