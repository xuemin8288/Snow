...
CREATE TABLE `doctor`  (
  ...
  `type_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地址',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '心理医生表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `feedback`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '反馈建议表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `reservation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '预约信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sideshow`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '轮播图信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `test_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '测试记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `test_record` VALUES (17, 7, 4, 2, 85, '可能存在肝阳上亢型高血压的风险', '2025-04-23 10:15:42');
INSERT INTO `test_record` VALUES (18, 8, 5, 2, 92, '可能存在肝肾阴虚型高血压的风险', '2025-04-23 10:18:37');
INSERT INTO `test_record` VALUES (19, 9, 6, 1, 88, '可能存在阴阳两虚型高血压的风险', '2025-04-23 10:21:14');
INSERT INTO `test_record` VALUES (20, 10, 7, 3, 83, '可能存在痰瘀内蕴型高血压的风险', '2025-04-23 10:24:56');
INSERT INTO `test_record` VALUES (21, 11, 8, 4, 96, '可能存在瘀血内停型高血压的风险', '2025-04-23 10:27:33');
INSERT INTO `test_record` VALUES (22, 7, 9, 2, 89, '可能存在肝阳上亢型高血压的风险', '2025-04-23 10:30:12');
INSERT INTO `test_record` VALUES (23, 8, 10, 2, 95, '可能存在肝肾阴虚型高血压的风险', '2025-04-23 10:32:45');
INSERT INTO `test_record` VALUES (24, 9, 11, 1, 81, '可能存在阴阳两虚型高血压的风险', '2025-04-23 10:35:27');
INSERT INTO `test_record` VALUES (25, 10, 12, 3, 87, '可能存在痰瘀内蕴型高血压的风险', '2025-04-23 10:38:19');
INSERT INTO `test_record` VALUES (26, 11, 12, 4, 98, '可能存在瘀血内停型高血压的风险', '2025-04-23 10:40:56');
INSERT INTO `test_record` VALUES (27, 7, 5, 2, 85, '可能存在肝阳上亢型高血压的风险', '2025-04-23 11:15:42');
INSERT INTO `test_record` VALUES (28, 8, 6, 2, 92, '可能存在肝肾阴虚型高血压的风险', '2025-04-23 11:18:37');
INSERT INTO `test_record` VALUES (29, 9, 7, 1, 88, '可能存在阴阳两虚型高血压的风险', '2025-04-23 11:21:14');
INSERT INTO `test_record` VALUES (30, 10, 8, 3, 83, '可能存在痰瘀内蕴型高血压的风险', '2025-04-23 11:24:56');
INSERT INTO `test_record` VALUES (31, 11, 9, 4, 96, '可能存在瘀血内停型高血压的风险', '2025-04-23 11:27:33');
...
CREATE TABLE `topic`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 118 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '题目信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '心理分类表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `type_add_map` VALUES (1, '厦门', 1);
INSERT INTO `type_add_map` VALUES (2, '厦门', 3);
INSERT INTO `type_add_map` VALUES (3, '厦门', 1);
INSERT INTO `type_add_map` VALUES (4, '厦门', 1);
INSERT INTO `type_add_map` VALUES (5, '厦门', 2);
INSERT INTO `type_add_map` VALUES (1, '福州', 1);
INSERT INTO `type_add_map` VALUES (2, '福州', 0);
INSERT INTO `type_add_map` VALUES (3, '福州', 0);
INSERT INTO `type_add_map` VALUES (4, '福州', 0);
INSERT INTO `type_add_map` VALUES (5, '福州', 0);
INSERT INTO `type_add_map` VALUES (1, '莆田', 1);
INSERT INTO `type_add_map` VALUES (2, '莆田', 1);
INSERT INTO `type_add_map` VALUES (3, '莆田', 0);
INSERT INTO `type_add_map` VALUES (4, '莆田', 0);
INSERT INTO `type_add_map` VALUES (5, '莆田', 0);
INSERT INTO `type_add_map` VALUES (1, '漳州', 0);
INSERT INTO `type_add_map` VALUES (2, '漳州', 0);
INSERT INTO `type_add_map` VALUES (3, '漳州', 1);
INSERT INTO `type_add_map` VALUES (4, '漳州', 1);
INSERT INTO `type_add_map` VALUES (5, '漳州', 0);
INSERT INTO `type_add_map` VALUES (1, '泉州', 0);
INSERT INTO `type_add_map` VALUES (2, '泉州', 1);
INSERT INTO `type_add_map` VALUES (3, '泉州', 1);
INSERT INTO `type_add_map` VALUES (4, '泉州', 0);
INSERT INTO `type_add_map` VALUES (5, '泉州', 0);
INSERT INTO `type_add_map` VALUES (1, '宁德', 0);
INSERT INTO `type_add_map` VALUES (2, '宁德', 0);
INSERT INTO `type_add_map` VALUES (3, '宁德', 0);
INSERT INTO `type_add_map` VALUES (4, '宁德', 1);
INSERT INTO `type_add_map` VALUES (5, '宁德', 1);
INSERT INTO `type_add_map` VALUES (1, '三明', 1);
INSERT INTO `type_add_map` VALUES (2, '三明', 0);
INSERT INTO `type_add_map` VALUES (3, '三明', 0);
INSERT INTO `type_add_map` VALUES (4, '三明', 0);
INSERT INTO `type_add_map` VALUES (5, '三明', 1);
INSERT INTO `type_add_map` VALUES (1, '南平', 1);
INSERT INTO `type_add_map` VALUES (2, '南平', 1);
INSERT INTO `type_add_map` VALUES (3, '南平', 0);
INSERT INTO `type_add_map` VALUES (4, '南平', 0);
INSERT INTO `type_add_map` VALUES (5, '南平', 0);
INSERT INTO `type_add_map` VALUES (1, '龙岩', 0);
INSERT INTO `type_add_map` VALUES (2, '龙岩', 1);
INSERT INTO `type_add_map` VALUES (3, '龙岩', 1);
...
INSERT INTO `user` VALUES (4, 'zhaoliu', '123456', '赵六', 'USER', '18811112222', 'zhaoliu@HTN.com', 'http://localhost:9090/files/download/zhaoliu.jpeg', '福州', '25', '男');
INSERT INTO `user` VALUES (5, 'sunqi', '123456', '孙七', 'USER', '18822223333', 'sunqi@HTN.com', 'http://localhost:9090/files/download/sunqi.jpeg', '莆田', '26', '女');
INSERT INTO `user` VALUES (6, 'zhouba', '123456', '周八', 'USER', '18833334444', 'zhouba@HTN.com', 'http://localhost:9090/files/download/zhouba.jpeg', '泉州', '27', '男');
INSERT INTO `user` VALUES (7, 'wujie', '123456', '吴杰', 'USER', '18844445555', 'wujie@HTN.com', 'http://localhost:9090/files/download/wujie.jpeg', '漳州', '28', '女');
INSERT INTO `user` VALUES (8, 'zhengshi', '123456', '郑十', 'USER', '18855556666', 'zhengshi@HTN.com', 'http://localhost:9090/files/download/zhengshi.jpeg', '宁德', '29', '男');
INSERT INTO `user` VALUES (9, 'liushi', '123456', '刘十一', 'USER', '18866667777', 'liushi@HTN.com', 'http://localhost:9090/files/download/liushi.jpeg', '三明', '30', '女');
INSERT INTO `user` VALUES (10, 'chenyi', '123456', '陈一', 'USER', '18877778888', 'chenyi@HTN.com', 'http://localhost:9090/files/download/chenyi.jpeg', '南平', '31', '男');
INSERT INTO `user` VALUES (11, 'huangyi', '123456', '黄一', 'USER', '18888889999', 'huangyi@HTN.com', 'http://localhost:9090/files/download/huangyi.jpeg', '龙岩', '32', '女');
INSERT INTO `user` VALUES (12, 'xuyi', '123456', '许一', 'USER', '18899990000', 'xuyi@HTN.com', 'http://localhost:9090/files/download/xuyi.jpeg', '厦门', '33', '男');
